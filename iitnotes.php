	...
	<div class="hero-area section">
			...
			<div class="container">
				...
				<div class="row">
                  ...
                  $q = "select * from addnotes where notes_class = 'IIT / JEE / NEET'";
              ...
              else
              {
                while($x=mysqli_fetch_array($res))
                {
                  ...
                  <table class="table-bordered" style="width: 100%;">
                    ...
                    <td class="p-2"><a href="adminuploads/notes?notes_id='$notes_id'">Download</a><!--<button class="btn btn-secondary" onclick="">Download</button>--></td>
                  </tr>
                      <?php
                         }
                  }
