			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						<h1 class="white-text">Manage Assignment</h1>
                    </div>
				</div>
			</div>
		...
		<div class="col-md-12 contact-form">
					...
					else
					{
						...
						while($x=mysqli_fetch_array($res))
						{
							...
							<td>$x[1]</td>
							<td>$x[2]</td>
							<td><a href='updateassignment.php?assign_id=$x[0]'>Update</a></td>
							<td><a href='delassignment.php?assign_id=$x[0]' onclick='return ConfirmDelete()'>Delete</a></td>
							</tr>";
						}
						print "</table>";
					}
